...
o	Tipo de incertidumbre que aborda
o	Nivel de complejidad
o	Ventajas y limitaciones
o	Requisitos de información
o	Nivel de madurez organizacional requerido
o	Aplicabilidad en ciberseguridad/ciberdefensa


Característica	Análisis Multicriterio (AMC)	Análisis Costo/Beneficio (ACB)	ALARP / ALARA (SFAIRP)	Índices de Riesgo (Ranking)
Objetivo de la técnica	Comparar opciones para que las soluciones intermedias (trade-offs) sean explícitas.	Utilizar el dinero como escala para estimar consecuencias positivas y negativas de las opciones.	Criterios para decidir la importancia del riesgo y evaluar su tolerabilidad.	Clasificar la importancia de los riesgos según calificaciones aplicadas a factores influyentes.
Tipo de incertidumbre que aborda	Incertidumbre multifacética asociada a la selección entre múltiples opciones y sistemas.	Incertidumbre en los resultados potenciales y en las estimaciones de costos y beneficios financieros.	Incertidumbre en la toma de decisiones, sistemas de valores y normas sociales de aceptabilidad.	Incertidumbre cuando es difícil especificar la naturaleza y posibilidad exacta de las consecuencias.
Nivel de complejidad	Moderado: Requiere conocimientos especializados y un esfuerzo de ejecución medio.	Alto: Demanda conocimientos técnicos y financieros profundos, con un esfuerzo de medio a alto.	Alto: Exige alta especialización para definir qué es "razonablemente viable" y un esfuerzo elevado.	Bajo/Moderado: Bajo esfuerzo para su uso diario, aunque el desarrollo del índice es moderado.
Ventajas y limitaciones	Ventaja: No requiere asignar valores monetarios a todos los elementos. Limitación: Los resultados dependen de la subjetividad en la ponderación.	Ventaja: Proporciona una escala común (monetaria) para comparar beneficios tangibles e intangibles. Limitación: Difícil de aplicar a activos sin valor comercial claro.	Ventaja: Define umbrales de tolerabilidad claros para la seguridad. Limitación: Puede ser complejo de justificar legalmente sin estándares claros.	Ventaja: Permite comparar y priorizar riesgos de manera rápida y estructurada. Limitación: Si no se valida, puede dar lugar a interpretaciones erróneas del cálculo.
Requisitos de información	Bajo: Se nutre principalmente de juicios de expertos y metas operacionales.	Medio/Alto: Requiere datos financieros, proyecciones de impacto y costos de implementación.	Alto: Necesita datos sobre niveles de riesgo y efectividad técnica de los controles propuestos.	Medio: Requiere definir escalas de calificación y factores de riesgo consistentes.
Madurez Organizacional Requerida	Media: Capacidad para definir criterios estratégicos y facilitar acuerdos entre partes interesadas.	Alta: Procesos financieros robustos y capacidad para valorar activos de información en términos económicos.	Muy Alta: Implementación en entornos críticos (energía, defensa) con cultura de seguridad rigurosa.	Baja/Media: Ideal para organizaciones que están iniciando la formalización de su gestión de riesgos.
